...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<Article> _allArticles = [
    ...
    Article(
      ...
      content: 'Flutter digunakan untuk membuat aplikasi mobile dari satu basis kode untuk Android dan iOS.',
      category: 'Teknologi',
      author: 'Admin',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Cari Artikel')),
      body: Column(
        children: [
          Padding(
                ...
                : _results.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _SearchResultCard(article: article, primaryColor: primaryColor);
                        },
                      ),
          ),
        ],
...
class _SearchResultCard extends StatelessWidget {
  ...
  const _SearchResultCard({required this.article, required this.primaryColor});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(article.title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
